                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        <div className="space-y-6 animate-fade-in">
                            ...
                            <div className="flex flex-wrap gap-4">
                                <Link to="/start-today" className="btn-primary">
                                    Get Started Today 🚀
                                </Link>
            ...
            <section className="section-padding bg-gradient-to-r from-primary-500 via-secondary-500 to-accent-500 text-white">
                <div className="container-custom text-center">
                    ...
                    <div className="flex flex-wrap justify-center gap-4">
                        <a
                            href={`https://wa.me/${import.meta.env.VITE_WHATSAPP_NUMBER || '923004251833'}?text=Hello! I'm interested in your services.`}
                            target="_blank"
