                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex space-x-3">
                            ...
                            <a href={`https://wa.me/${import.meta.env.VITE_WHATSAPP_NUMBER || '923004251833'}`} target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-primary-600 hover:bg-primary-700 rounded-full flex items-center justify-center transition-colors">
                                💬
                            </a>
                        </div>
                    </div>
