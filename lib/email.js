...
export const sendNewReviewNotification = async (review) => {
    const templateParams = {
        to_email: ADMIN_EMAIL,
        to_name: 'Admin',
...
export const sendReviewApprovalNotification = async (review) => {
    const templateParams = {
...
export const sendCustomEmail = async (to, subject, message, toName = 'Customer') => {
    const templateParams = {
        to_email: to,
        to_name: toName,
        subject,
